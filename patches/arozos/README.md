...
|-------|---------------|-------------|
| `joshu-core.patch` | `8894ffe` | System settings hook, desktop splash/overlay recovery, float-window drag/resize stability, media player, stock-module denylist (`HiddenModules`) |
