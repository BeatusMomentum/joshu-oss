...
**Gaps:** Tango has **no telephone / handset glyph**. `arozos/icons/telephone.png` (Telephone app) therefore comes from the **GNOME icon theme** `call-start` (CC BY-SA 3.0 US) and is **not** regenerated by `build-arozos-desktop-file-icons.sh` — see [`docs/THIRD_PARTY.md`](../../docs/THIRD_PARTY.md#design-assets).
